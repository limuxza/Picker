        ...
        function TabElements.ColorPicker(config)
            ...
            local function createColorPickerDialog()
                ...
                local function updateCurrentColor()
                    ...
                    local PreviewBox = DialogFrame:FindFirstChild("PreviewBox")
                    if PreviewBox then
                ...
                local PreviewFrame = Linux.Instance("Frame", {
                    Parent = DialogFrame,
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, -20, 0, 40),
                    Position = UDim2.new(0, 10, 0, isMobile and 190 or 210),
                    ZIndex = 1002
                })
                
                local PreviewBox = Linux.Instance("Frame", {
                    Parent = PreviewFrame,
                    BackgroundColor3 = CurrentColor,
                ...
                RedSlider, RedValue = createRGBSlider("R", UDim2.new(0, 15, 0, isMobile and 235 or 255), math.floor(CurrentColor.R * 255))
                GreenSlider, GreenValue = createRGBSlider("G", UDim2.new(0, 15, 0, isMobile and 255 or 275), math.floor(CurrentColor.G * 255))
                BlueSlider, BlueValue = createRGBSlider("B", UDim2.new(0, 15, 0, isMobile and 275 or 295), math.floor(CurrentColor.B * 255))
